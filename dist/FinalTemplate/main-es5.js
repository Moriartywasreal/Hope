...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsFeaturedFeaturedComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsLandingLandingComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-banner></app-banner>\n";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsSportsSportsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppApiApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      function ApiService(httpClient) {
        ...
        this.httpClient = httpClient; // apiURL: string = 'http://localhost:8080/api';
      ...
      _createClass(ApiService, [{
        ...
        value: function getCategories() {
          ...
          return this.httpClient.get("".concat(this.apiURL, "/categories"));
        }
      }, {
        key: "getCategoryById",
        value: function getCategoryById(cat_id) {
          console.log(cat_id);
          return this.httpClient.get("".concat(this.apiURL, "/categories/") + cat_id);
        }
      }, {
        key: "getContents",
        value: function getContents() {
          return this.httpClient.get("".concat(this.apiURL, "/Content"));
        }
      }, {
        key: "getContentById",
        value: function getContentById(content_id) {
          return this.httpClient.get("".concat(this.apiURL, "/Content/") + content_id);
        }
      }, {
        key: "getContentsByCategoryId",
        value: function getContentsByCategoryId(cat_id) {
          return this.httpClient.get("".concat(this.apiURL, "/Content/?categories_id=") + cat_id);
        }
      }, {
        key: "addCategory",
        value: function addCategory(data) {
          ...
          return this.httpClient.post("".concat(this.apiURL, "/categories/"), this.categoryData);
        }
      }, {
        key: "updateCategory",
        value: function updateCategory(data) {
          ...
          this.categoryData = Object.assign({}, this.categoryData ? this.categoryData : {}, JSON.parse(JSON.stringify(data.value)));
          console.log(this.categoryData);
          return this.httpClient.put("".concat(this.apiURL, "/categories/") + this.categoryData.id, this.categoryData);
        }
      }, {
        key: "approveContent",
        value: function approveContent(data) {
          console.log("stored", data);
          this.contentData = Object.assign({}, this.contentData ? this.contentData : {}, JSON.parse(JSON.stringify(data.value)));
          console.log(this.contentData);
          return this.httpClient.put("".concat(this.apiURL, "/Content/") + this.contentData.id, this.contentData);
        }
      }, {
        key: "postContent",
        value: function postContent(data) {
          return this.httpClient.post("".concat(this.apiURL, "/Content/"), data);
        }
      }]);
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_category_category_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_featured_featured_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/featured/featured.component */
    "./src/app/components/featured/featured.component.ts");
    /* harmony import */


    var _components_sports_sports_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/sports/sports.component */
    "./src/app/components/sports/sports.component.ts");
    /* harmony import */


    var _components_banner_banner_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var _components_category_category_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/category/category.component */
    "./src/app/components/category/category.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_6__["HomeComponent"], _components_featured_featured_component__WEBPACK_IMPORTED_MODULE_7__["FeaturedComponent"], _components_sports_sports_component__WEBPACK_IMPORTED_MODULE_8__["SportsComponent"], _components_banner_banner_component__WEBPACK_IMPORTED_MODULE_9__["BannerComponent"], _components_landing_landing_component__WEBPACK_IMPORTED_MODULE_10__["LandingComponent"], _components_category_category_component__WEBPACK_IMPORTED_MODULE_11__["CategoryComponent"]],
  ...
  /***/
  function srcAppComponentsBannerBannerComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsBannerBannerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BannerComponent = /*#__PURE__*/function () {
      function BannerComponent(service, route, router) {
      ...
      _createClass(BannerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.service.getCategories().subscribe(function (res) {
            ...
            _this.service.getContents().subscribe(function (response) {
        ...
        value: function modifyCategories() {
    ...
    BannerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/components/banner/banner.component.css"))["default"]]
    })], BannerComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsCategoryCategoryComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsCategoryCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CategoryComponent = /*#__PURE__*/function () {
      function CategoryComponent(route, service) {
        ...
        value: function ngOnInit() {
          ...
          this.route.params.subscribe(function (params) {
            if (params.category_id) {
              _this2.categoryId = params.category_id;
            }
          });
          console.log(this.categoryId);
          this.service.getCategoryById(this.categoryId).subscribe(function (res) {
            _this2.category = res;
            console.log("category", _this2.category);
          });
          this.service.getContentsByCategoryId(this.categoryId).subscribe(function (response) {
            _this2.contents = response;
          });
        }
      }]);
    ...
    CategoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/components/category/category.component.css"))["default"]]
    })], CategoryComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsFeaturedFeaturedComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsFeaturedFeaturedComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    FeaturedComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-featured',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./featured.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/featured/featured.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./featured.component.css */
      "./src/app/components/featured/featured.component.css"))["default"]]
    })], FeaturedComponent);
    /***/
  },
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.service.getCategories().subscribe(function (res) {
            ...
            _this3.service.getContents().subscribe(function (response) {
              _this3.contents = response;
              console.log(_this3.contents);

              _this3.categories.forEach(function (element) {
                var contents = [];
                var counter = 1;

                _this3.contents.forEach(function (ele) {
                  if (element.id == ele.categories_id && counter <= 3) {
                    contents.push(ele);
                    counter = counter + 1;
                  }
              ...
              _this3.categories.forEach(function (cat) {
                if (cat.contents) {
                  cats.push(cat);
                }
              });
  ...
  /***/
  function srcAppComponentsSportsSportsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsSportsSportsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    SportsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/sports/sports.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./sports.component.css */
      "./src/app/components/sports/sports.component.css"))["default"]]
    })], SportsComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\self_projects\Hope - frontend\Hope\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
